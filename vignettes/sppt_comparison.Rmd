---
title: "Comparing SPPT output: R vs Java"
...
[Nick Malleson](http://nickmalleson.co.uk) has programmed a [Java application](https://github.com/sppt/sppt/tree/master/java) for the SPPT, including a graphical user interface. The `sppt` R function was programmed by [Wouter Steenbeek](http://www.woutersteenbeek.nl) independently. This vignette compares the output of the R function and Java application, showing their differences.
...
The R function takes between **2 and 3 seconds**, a massive speed increase compared to the Java application.
