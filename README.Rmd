...
functions were added to the package as a result of the following publication:
...
For version 0.1.5 and above, the updated reference is (change version number
accordingly):
