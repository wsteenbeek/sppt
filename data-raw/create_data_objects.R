...
usethis::use_data(areas.sp, points1.sp, points2.sp, overwrite = TRUE)
...
usethis::use_data(vancouver_areas.sp, vancouver_points1.sp, vancouver_points2.sp, overwrite = TRUE)
